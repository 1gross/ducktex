						...
						<div class="bx_filter_block">
							<div class="bx_filter_parameters_box_container clearfix">
								<div class="bx_filter_popup_result right" id="modef_mobile" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?>>
									...
									<a href="<?echo $arResult["FILTER_URL"]?>" class="js-init-filter_apply button white_bg"><?echo GetMessage("CT_BCSF_FILTER_SHOW")?></a>
								</div>
								...
								<input class="btn blue small js-init-filter_apply" type="submit"  value="<?=GetMessage("CT_BCSF_SET_FILTER")?>" />
								<input style="display: none;" class="bx_filter_search_reset button small transparent" type="reset" id="del_filter" name="del_filter" value="<?=GetMessage("CT_BCSF_DEL_FILTER")?>" />
							</div>
						</div>
					</div>
				<?}?>
