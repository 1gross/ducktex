...
if ($arResult['ITEMS']) {
    foreach ($arResult['ITEMS'] as $k => $arItem) {
        ...
        $arResult['ITEMS'][$k]['DISCOUNT'] = $arDiscount ?: false;

        if ($arItem['PREVIEW_PICTURE']['SRC'] || $arItem['DETAIL_PICTURE']['SRC']) {
            $arResult['ITEMS'][$k]['PICTURE'] = $arItem['PREVIEW_PICTURE']['SRC'] ?: $arItem['DETAIL_PICTURE']['SRC'];
        } else {
            $arResult['ITEMS'][$k]['PICTURE'] = NO_IMAGE;
        }
    }
}